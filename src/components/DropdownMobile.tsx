...
const DropdownMobile = () => {
  ...
  return (
    <>
      ...
      <span
        className={cn(
          "absolute -bottom-40 max-w-full! sm:w-80 w-50 justify-start items-start bg-white dark:bg-neutral-900 transition-all rounded-xl ring-1 ring-neutral-200 dark:ring-neutral-800",
          open

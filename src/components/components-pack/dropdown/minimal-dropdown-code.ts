export const minimalDropdownCode = `"use client";
                ...
                <button
                  ...
                  className={\`w-full flex items-center px-4 py-2 text-left transition-colors \${
                    item.isDisabled
                      ...
                      : "text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 rounded-lg dark:hover:bg-neutral-800"
                  }\`}
                  onClick={() => {
                    if (!item.isDisabled) {
                      console.log(\`Clicked: \${item.label}\`);
...
export default MinimalDropdown;`.trim(); 
export const accentDropdownCode = `"use client";
...
const AccentDropdown = () => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div 
          className="w-full mt-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl shadow-lg overflow-hidden animate-fadeInDown"
        >
          <div className="py-2">
            {menuItems.map((item) => {
...
export default AccentDropdown;`.trim(); 
export const contactCTAButtonCode = `"use client";
...
export default function ContactCTAButton({ 
  ...
  const baseClasses = cn(
    ...
    variant === "default" && "bg-neutral-900 dark:bg-white text-white dark:text-black hover:bg-neutral-800 dark:hover:bg-neutral-100",
    variant === "outline" && "border-2 border-neutral-300 dark:border-neutral-600 text-neutral-900 dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800",
    className
  );

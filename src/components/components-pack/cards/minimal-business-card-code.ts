export const minimalBusinessCardCode = `import { socials } from "@/lib/socials";
...
const MinimalBusinessCard = () => {
  const imagePath: string | undefined = people[2].src;
  ...
  return (
    <div className="font-sans flex justify-center items-center m-auto sm:p-0">
      <div className="flex flex-col bg-white dark:bg-neutral-800 shadow-lg ring-4 ring-neutral-200/70 dark:ring-neutral-700/70 w-full max-w-lg rounded-3xl divide-y divide-neutral-100 dark:divide-neutral-700">
        ...
        <div className="p-4 grid grid-cols-8">
          ...
          <div className="flex flex-col col-span-5">
            <h3 className="font-semibold text-lg text-gray-900 dark:text-neutral-100">John Doe</h3>
            <p className="text-sm text-neutral-400 dark:text-neutral-400">
              Founder of Company
            </p>
            <p className="text-sm text-neutral-400 dark:text-neutral-400">New York, USA</p>
          </div>
        </div>
        <div className="">
          <div className="flex flex-col divide-y divide-neutral-100 dark:divide-neutral-700">
            {socials.map((social, i) => {
              ...
              const socialHandle = socialHandles.find(s => s.name === social.name);

export const tooltipImageLinkCode = `"use client";
...
// Usage examples:
// <ToolTipImageLink />
// You can customize the linkUrl variable to point to any URL you want
// Perfect for showcasing website previews with interactive tooltips`; 
...
import { LuSearch, LuCalendar, BiCommand, LuFile } from "@/utils/icons";
import {
  BsEmojiSmile,
  BsCalculator,
  BsPerson,
      ...
      <div className="relative w-full flex flex-col gap-y-2 h-full rounded-2xl overflow-hidden bg-white dark:bg-indigo-950/30 p-3">
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <div className="flex items-center justify-between px-2 py-1 hover:bg-gradient-to-r hover:from-neutral-200 hover:to-transparent dark:hover:from-indigo-950 dark:hover:to-transparent rounded-lg cursor-pointer transition-colors">
              <div className="flex items-center">

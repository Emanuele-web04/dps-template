...
const Card = ({ children, className = "", featured = false }: CardProps) => {
  ...
  const featuredStyles = featured ? "bg-neutral-950 text-white shadow-lg shadow-neutral-900/50" : "bg-white text-neutral-900 ring-1 ring-neutral-200"
...
export default function PricingSection() {
  return (
    <section className="py-16 fade-in-up px-4 bg-neutral-50 min-h-screen">

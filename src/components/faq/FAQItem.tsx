...
const FAQItem = ({ question, answer }: FAQ) => {
  ...
  return (
    <button
      className="flex flex-col cursor-pointer min-w-[340px] xs:min-w-md sm:min-w-2xl md:min-w-4xl lg:min-w-5xl items-center justify-center pb-4 w-full"
      onClick={handleOpening}
    >
      <div className="flex flex-col gap-x-1 px-4 md:px-6 lg:px-8 max-w-[300px] xs:max-w-sm sm:max-w-xl md:max-w-3xl lg:max-w-4xl w-full items-center justify-between">

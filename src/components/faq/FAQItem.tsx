...
const FAQItem = ({ question, answer }: FAQ) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-x-3 px-4 md:px-6 lg:px-8 max-w-xs xs:max-w-sm sm:max-w-xl md:max-w-3xl lg:max-w-4xl w-full items-center justify-between">

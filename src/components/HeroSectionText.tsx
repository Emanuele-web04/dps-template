...
const HeroSectionText = () => {
  return (
    <div className="w-fit">
      <h1 className=" w-fit flex flex-col gap-2 sm:gap-5 title">
        ...
        <span className="flex items-center gap-x-3">
          beautiful{" "}
          <span className="border-1 border-dotted relative border-gray-500 bg-neutral-900 backdrop-blur-2xl p-1 md:p-2 pb-3 md:pb-5 ">

...
const HeroSectionText = () => {
  return (
    <div className="w-fit">
      <h1 className="font-sans  w-fit flex flex-col gap-5 font-bold tracking-tighter text-6xl">
        <span>
          Enhance your{" "}
          ...
          and{" "}
          <span className="bg-gradient-to-b bg-clip-text text-transparent from-gray-200 via-gray-300 to-gray-500">
            SaaS
          </span>
        </span>
        <span className="flex items-center gap-x-3">
          with beautiful{" "}
          <span className="border-1 border-dotted relative border-gray-500 bg-neutral-900 backdrop-blur-2xl p-2 pb-5 pr-3">

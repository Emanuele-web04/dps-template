  ...
  return (
    <div className="w-fit">
      <h1 className="font-sans w-fit flex flex-col gap-2 sm:gap-5 font-bold tracking-tighter text-3xl sm:text-5xl md:text-6xl">
        ...
        <span>
          <span className="bg-gradient-to-b text-5xl md:text-6xl pr-0.5 bg-clip-text text-transparent from-orange-300 via-orange-400 to-orange-600">
            Apps
          </span>{" "}
          and{" "}
          <span className="bg-gradient-to-b text-5xl md:text-6xl pr-0.5 bg-clip-text text-transparent from-gray-200 via-gray-300 to-gray-500">
            SaaS
          </span>{" "}
          with
        </span>
        <span className="flex items-center gap-x-3">
          beautiful{" "}
          <span className="border-1 border-dotted relative border-gray-500 bg-neutral-900 backdrop-blur-2xl p-1 md:p-2 pb-3 md:pb-5 px-2">
